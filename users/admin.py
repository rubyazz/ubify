...
class CustomUserAdmin(UserAdmin):
    ...
    list_display = ('first_name', 'last_name', 'email', 'is_active', 'is_singer', 'is_listener')
    ...
    fieldsets = (
        ...
        ('Permissions', {'fields': ('is_active', 'is_singer', 'is_listener', 'groups', 'user_permissions')}),
    ...
    add_fieldsets = (
        (None, {
            'classes': ('wide',),
            'fields': ('first_name', 'last_name', 'email', 'password1', 'password2', 'is_singer', 'is_listener'),
        }),
    )
