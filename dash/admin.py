...
class SingerAdmin(admin.ModelAdmin):
    list_display = ('name', 'nickname', 'img') # Specify fields to be displayed in the list view
    list_filter = ('name',) # Add filters for filtering the list view
    search_fields = ('name', 'nickname') # Add search fields for searching the list view
